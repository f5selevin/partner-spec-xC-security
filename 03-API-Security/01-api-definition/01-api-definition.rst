...
3. Name the definition ``arcadia-openbanking-api``.
...
.. important::
   ...
   Keep API Discovery disabled on the ``arcadia-openbanking`` load balancer. Do not configure a code-base repository, source-code integration, or GitHub credentials. This lab uses only the directly uploaded OpenAPI document.
