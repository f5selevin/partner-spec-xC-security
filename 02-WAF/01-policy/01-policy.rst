...
2. Name the policy ``arcadia-finance-waf``.
...
4. Save the firewall.
5. Go to **Load Balancers** > **HTTP Load Balancers**, manage ``arcadia-finance``, and select **Edit Configuration**.
6. Under **Web Application Firewall**, select **Enable** and attach ``arcadia-finance-waf``.
